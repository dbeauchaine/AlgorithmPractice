...
describe("rotateArrayTests", () => {
    const testCases: TestCase[] = [
        ...
        { arrayToRotate: [1, 2, 4], arraySolution: [1, 2, 4], steps: 3, description: "rotate 3 with 3 elements. Full rotation." },
        { arrayToRotate: [1, 2, 4], arraySolution: [4, 1, 2], steps: 4, description: "rotate 4 with 3 elements, more than full rotation." }
    ];
